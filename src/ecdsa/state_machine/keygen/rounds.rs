...
pub struct Round3 {
  ...
  bc_vec: Vec<crate::ecdsa::party_i::KeyGenBroadcastMessage1>,
...
pub struct Round4 {
  ...
  y_vec: Vec<Point<Secp256k1>>,
  bc_vec: Vec<crate::ecdsa::party_i::KeyGenBroadcastMessage1>,
  shared_keys: crate::ecdsa::party_i::SharedKeys,
...
pub struct LocalKey<E: Curve> {
  ...
  pub keys_linear: crate::ecdsa::party_i::SharedKeys,
