...
pub struct Keygen {
  ...
  msgs1: Option<Store<BroadcastMsgs<crate::ecdsa::party_i::KeyGenBroadcastMessage1>>>,
  msgs2: Option<Store<BroadcastMsgs<crate::ecdsa::party_i::KeyGenDecommitMessage1>>>,
...
enum M {
  Round1(crate::ecdsa::party_i::KeyGenBroadcastMessage1),
  Round2(crate::ecdsa::party_i::KeyGenDecommitMessage1),
